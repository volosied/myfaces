...
const wrap_1 = __importDefault(require("./lib/wrap"));
...
*/`)}
${chalk_1.default.cyan('filterResults')}: (packageName, { currentVersion, currentVersionSemver, upgradedVersion, upgradedVersionSemver }) ${chalk_1.default.cyan('=>')} {
  const currentMajorVersion = currentVersionSemver?.[${chalk_1.default.blue('0')}]?.major
  const upgradedMajorVersion = upgradedVersionSemver?.major
  ${chalk_1.default.red('if')} (currentMajorVersion ${chalk_1.default.red('&&')} upgradedMajorVersion) {
    ${chalk_1.default.red('return')} currentMajorVersion ${chalk_1.default.red('<')} upgradedMajorVersion
  }
  ${chalk_1.default.red('return')} ${chalk_1.default.blue('true')}
}`, { markdown })}
...
*/`)}
${chalk_1.default.cyan('groupFunction')}: (name, defaultGroup, currentSpec, upgradedSpec, upgradedVersion) ${chalk_1.default.cyan('=>')} {
  ...
  ${chalk_1.default.red('if')} (name.startsWith('@myorg/')) {
...
${chalk_1.default.cyan('target')}: (dependencyName, [{ semver, version, operator, major, minor, patch, release, build }]) ${chalk_1.default.cyan('=>')} {
  ${chalk_1.default.red('if')} (major ${chalk_1.default.red('===')} ${chalk_1.default.yellow("'0'")}) ${chalk_1.default.red('return')} ${chalk_1.default.yellow("'minor'")}
...
const cliOptions = [
    ...
    },
    {
        ...
        help: (0, wrap_1.default)(`Specify the registry to use when looking up package version numbers.
